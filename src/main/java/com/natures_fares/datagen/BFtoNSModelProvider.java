...
public class BFtoNSModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        registerFruitLogModels(blockStateModelGenerator, NSWoods.CYPRESS.getStrippedLog(), NSWoods.CYPRESS.getStrippedWood());
        registerFruitLogModels(blockStateModelGenerator, NSWoods.GHAF.getStrippedLog(), NSWoods.GHAF.getStrippedWood());
        registerFruitLogModels(blockStateModelGenerator, NSWoods.LARCH.getStrippedLog(), NSWoods.LARCH.getStrippedWood());
        registerFruitLogModels(blockStateModelGenerator, NSWoods.SAXAUL.getStrippedLog(), NSWoods.SAXAUL.getStrippedWood());
        registerFruitLogModels(blockStateModelGenerator, NSWoods.PALO_VERDE.getStrippedLog(), NSWoods.PALO_VERDE.getStrippedWood());
